...
error: process didn't exit successfully: `target\debug\circom.exe circomlib/test/circuits/pedersen_test.circom` (exit code: 0xc00000fd, STATUS_STACK_OVERFLOW)
*/